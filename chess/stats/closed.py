...
coScholasticPdf = getPDFContent("C:\\Jackson\\Server\\Apache24\\htdocs\\stats\\2013CSCAStateFinalStandings.pdf").encode("ascii", "ignore")
...
<body>
<a href="index.html"><h2>Colorado Chess Top """ + str(ntop) + """ Ratings</h2></a>
<div id="tabs">
  <ul>
    ...
    <li><a href="#tabs-4">Superlatives</a></li>
...
<div id="tabs-4">
<p>Here are where the Colorado Chess superlatives will be!</p>
<p>First you need to vote for CO chess players for these superlatives.</p>
<p>Credit for the superlative questions go to Walter Smith</p>
<iframe src="https://docs.google.com/forms/d/1Wv6kCwoVd8UUgEw6DJYZWHjm5MiPYezghCOxnt0-mqg/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
</div>

<div id="tabs-5">
<p>This website is a live rating site for the highest rated Colorado chess players in three categories. This website will be updated weekly, usually on a weekday in order to include the past weekend's tournament results. Superlatives are also included on this site, so be sure to vote!</p>
...
<p>The tournament might not reflect the rating and ranking changes shown, this is because the rating and ranking changes are the changes throughout the entire month, while the tournament is the most recent tournament the player played in.
...
file_handle = open("C:\\Jackson\\Server\\Apache24\\htdocs\\stats\\closed.html", 'w')
